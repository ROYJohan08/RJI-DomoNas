...
echo "/dev/disk/by-uuid/569B-EA54 /boot/efi vfat defaults 0 1" >> /etc/fstab
echo "/dev/sdd1 /media/Series01 auto nosuid,nodev,nofail,x-gvfs-show 0 0" >> /etc/fstab
#echo "/dev/disk/by-uuid/6877284162D6D93C /media/Series02 auto nosuid,nodev,nofail,x-gvfs-show 0 0" >> /etc/fstab
echo "/dev/sde1 /media/Series03 auto nosuid,nodev,nofail,x-gvfs-show 0 0" >> /etc/fstab
echo "/dev/sdg1 /media/Films01 auto nosuid,nodev,nofail,x-gvfs-show 0 0" >> /etc/fstab
echo "/dev/sdc1 /media/Films02 auto nosuid,nodev,nofail,x-gvfs-show 0 0" >> /etc/fstab
echo "/dev/sda1 /media/Runable auto nosuid,nodev,nofail,x-gvfs-show 0 0" >> /etc/fstab
echo "/dev/sdf1 /media/Docs01 auto nosuid,nodev,nofail,x-gvfs-show 0 0" >> /etc/fstab


#echo "/dev/disk/by-uuid/2FB75EE05993C324 /media/Docs01 auto nosuid,nodev,nofail,x-gvfs-show 0 0" >> /etc/fstab #Disk HS temp.
